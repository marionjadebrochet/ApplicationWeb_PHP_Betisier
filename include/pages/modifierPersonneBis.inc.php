...
<p> L'étudiant à bien été modifié,et c'est devenu un salarié</p>
...
<p> Le salarié à bien été modifié</p>
<?php }else{
  $personne = unserialize($_SESSION['personne']);
  $personneManager->update($personne, $_GET["numero"]);
  ?>
...
<p> Le salarié à bien été modifié, et c'est devenu un étudiant</p>
<?php }
}
} ?>
